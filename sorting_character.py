...
class Extract_Letters:
    def extractFile(self, filename):
        ...
        image = imread(filename,flatten=True,mode='L')
...
#BELOW IS THE CODE FOR EXTRACTING A LETTERS AND NUMBERS TRAINING DATASET FROM IMAGES OF 
#A TO Z AND 1 TO 9 IN DIFFERENT FONTS.
